...
CREATE PROCEDURE [Test].[SP_GetAllBranchView]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_GetAllProvince]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_GetAllCity]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_GetAllCityView]
AS
BEGIN
...
GO
CREATE PROCEDURE [Test].[SP_InsertBranch]
    @CityId INT,
    @Code INT,
    @Name NVARCHAR(100),
    @Address NVARCHAR(500),
...
GO
CREATE PROCEDURE [Test].[SP_InsertProvince]
    @Code INT = NULL,
    @Name NVARCHAR(100)
AS
BEGIN
...
GO
CREATE PROCEDURE [Test].[SP_InsertCity]
    @Code INT = NULL,
    @Name NVARCHAR(100),
    @ProvinceId INT
AS
...
GO
CREATE PROCEDURE [Test].[SP_InsertTestGroup]
    @UserId INT,
    @Code INT = NULL,
    @Title NVARCHAR(100),
    @ParentId INT,
...
CREATE PROCEDURE [Test].[SP_GetAllTestGroupView]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_GetTestGroupWithoutSubset]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_GetAllTestItemView]
AS
BEGIN
...
CREATE PROCEDURE [Test].[SP_InsertRule]
    @UserId INT ,
    @Title NVARCHAR(250),
    @Text NVARCHAR(MAX)
AS
...
CREATE PROCEDURE [Test].[SP_GetAllRule]
AS
BEGIN
...
--exec [Test].[SP_GetAllTestGroupView]
